...
import type { GetLeadsParams, SendMessageParams, LeadsListResponse } from '~/interfaces/services/CrmServiceParams';
import { BaseService } from './BaseService';

export default class CrmService extends BaseService {
  async getLeads (data: GetLeadsParams | null = null): Promise<ApiResponse<LeadsListResponse>> {
    return await this.get<LeadsListResponse>('crm/leads', data);
  }
