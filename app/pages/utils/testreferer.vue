    ...
    <div class="grid grid-cols-1 xl:grid-cols-2 gap-6">
      ...
      <Card>
        ...
        <template #content>
          <div class="space-y-4">
            <div class="space-y-2">
              <label for="referersingle" class="block text-sm font-medium" style="color: var(--text-color);">
      ...
      <Card>
        ...
        <template #content>
          <div class="space-y-4">
            <div class="space-y-2">
              <label for="referer" class="block text-sm font-medium" style="color: var(--text-color);">
                <i class="pi pi-globe text-gray-400 mr-2"></i>
                {{ t('Referer Base') }}
              </label>
              <InputText 
      ...
      <Card>
        <template #content>
          <div class="text-center py-12">
            ...
            <p style="color: var(--text-color-secondary);">{{ t('Ingrese un referer o configuración para comenzar las pruebas') }}</p>
          </div>
        </template>
      </Card>
    </div>
      ...
      <Card>
        <template #content>
          <div class="text-center py-12">
            ...
            <p style="color: var(--text-color-secondary);">{{ t('Por favor espere mientras se procesan los referers') }}</p>
          </div>
        </template>
      </Card>
    </div>
