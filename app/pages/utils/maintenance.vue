  ...
  <div class="card">
    <div class="surface-section px-4 py-8 md:px-6 lg:px-8 text-center mb-5">
      ...
      <BlockUI :blocked="blocked">
        <div class="grid">
          <div v-show="actionsList?.length > 0" v-for="action in actionsList" :key="action.icon" class="col-12 md:col-4 mb-4 px-5" style="cursor:pointer;" @click="confirmAction($event, action.name, action.title)">
          ...
          <div v-show="!actionsList?.length" class="col-12 px-5">
