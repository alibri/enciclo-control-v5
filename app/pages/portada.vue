    ...
    <div class="space-y-6">
      ...
      <div v-if="fields.includes('imagen')" class="space-y-4">
        ...
        <div class="space-y-3">
          ...
          <!-- Image Preview -->
          <div v-if="editData.imagen" class="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-4 bg-gray-50 dark:bg-gray-800">
          ...
          <div v-else class="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-6 text-center bg-gray-50 dark:bg-gray-800">
