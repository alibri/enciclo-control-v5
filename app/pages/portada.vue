    ...
    <div class="space-y-6">
      ...
      <div v-if="fields.includes('imagen')" class="space-y-4">
        ...
        <div class="space-y-3">
          ...
          <!-- Image Preview -->
          <div v-if="editData.imagen" class="border-2 border-dashed rounded-lg p-4" style="border-color: var(--surface-border); background-color: var(--surface-card);">
          ...
          <div v-else class="border-2 border-dashed rounded-lg p-6 text-center" style="border-color: var(--surface-border); background-color: var(--surface-card);">
