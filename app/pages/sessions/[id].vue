  ...
  <span>
    <div class="card">
      <div class="grid p-1">
        ...
        <div v-if="!isGroup" class="col-12 lg:col-6 xl:col-6">
          <div class="surface-section">
            <ul class="list-none p-0 m-0">
              ...
              <li class="flex align-items-center py-3 px-2 border-top-1 surface-border flex-wrap">
                ...
                <div class="text-900 w-full md:w-8 md:flex-order-0 flex-order-1 text-yellow-500">
                  {{ stats?.session?.ip }}
                </div>
              </li>
              <li class="flex align-items-center py-3 px-2 border-top-1 surface-border flex-wrap">
              ...
              <li class="flex align-items-center py-3 px-2 border-top-1 surface-border flex-wrap">
                ...
                <div class="text-900 w-full md:w-8 md:flex-order-0 flex-order-1 text-xs text-400">
                  {{ stats?.session?.agent }}
                </div>
              </li>
              <li class="flex align-items-center py-3 px-2 border-top-1 surface-border flex-wrap">
              ...
              <li class="flex align-items-center py-3 px-2 border-top-1 surface-border flex-wrap">
                ...
                <div class="text-900 w-full md:w-8 md:flex-order-0 flex-order-1  text-green-500">
              ...
              <li class="flex align-items-center py-3 px-2 border-top-1 surface-border flex-wrap">
                ...
                <div class="text-900 w-full md:w-8 md:flex-order-0 flex-order-1 text-blue-300">
        ...
        <div v-if="isGroup" class="col-12 lg:col-12 xl:col-12">
