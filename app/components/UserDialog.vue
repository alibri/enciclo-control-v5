    ...
    <div class="grid grid-cols-12 gap-6">
          ...
          <div class="col-span-12">
            <div class="space-y-3">
              <div class="flex items-center gap-2">
                ...
                <label for="isenabled" class="font-medium" style="color: var(--text-color);">{{ t('Activo') }}</label>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="grid grid-cols-12 gap-2">
          <div class="col-span-3">
            <div class="flex items-center gap-2">
              ...
              <label for="isadmin" class="font-medium" style="color: var(--text-color);">{{ t('Admin') }}</label>
            </div>
          </div>
          <div class="col-span-3">
            <div class="flex items-center gap-2">
              ...
              <label for="iseditor" class="font-medium" style="color: var(--text-color);">{{ t('Editor') }}</label>
            </div>
          </div>
          <div class="col-span-3">
            <div class="flex items-center gap-2 h-full" style="align-items: center;">
              ...
              <label for="dashboard_access" class="font-medium" style="color: var(--text-color);">{{ t('Dashboard') }}</label>
            </div>
          </div>
          <div class="col-span-3">
            <div class="flex items-center gap-2">
              ...
              <label for="istester" class="font-medium" style="color: var(--text-color);">{{ t('Pregúntame') }}</label>
            </div>
          </div>
        </div>
      </Fieldset>
      ...
      <Fieldset :legend="t('Información Básica')" class="col-span-12">
        <div class="grid grid-cols-12 gap-4">
          <div class="col-span-6 mb-4">
            <FloatLabel variant="in">
              <label for="name1" class="block text-sm font-medium mb-2" style="color: var(--text-color);">{{ t('Nombre') }}</label>
              <InputText id="name1" v-model="user.name" type="text" class="w-full" />
            </FloatLabel>
          </div>
          <div class="col-span-6 mb-4">
            <FloatLabel variant="in">
              <label for="email1" class="block text-sm font-medium mb-2" style="color: var(--text-color);">{{ t('Email') }}</label>
        ...
        <div class="grid grid-cols-12 gap-4">
          <div class="col-span-6 mb-4">
            <FloatLabel variant="in" class="w-full">
              <label for="user" class="block text-sm font-medium mb-2" style="color: var(--text-color);">{{ t('Usuario') }}</label>
              <InputText id="user" v-model="user.user" type="text" />
            </FloatLabel>
          </div>
          <div class="col-span-6 mb-4">
            <FloatLabel variant="in">
              <label for="passwd" class="block text-sm font-medium mb-2" style="color: var(--text-color);">{{ t('Contraseña') }}</label>
        ...
        <div class="grid grid-cols-12 gap-4">
          <div class="col-span-6 mb-4">
            <FloatLabel variant="in">
              <label for="grupo" class="block text-sm font-medium mb-2" style="color: var(--text-color);">{{ t('Grupo') }}</label>
              <InputText id="grupo" v-model="user.grupo" type="text" class="w-full" />
            </FloatLabel>
          </div>
          <div class="col-span-6 mb-4">
            <FloatLabel variant="in">
              <label for="meta" class="block text-sm font-medium mb-2" style="color: var(--text-color);">{{ t('Meta Por Defecto') }}</label>
      ...
      <Fieldset :legend="t('Configuración de Acceso')" class="col-span-12">
        <div class="grid grid-cols-12 gap-4">
          <div class="col-span-4">
            <FloatLabel variant="in">
              <label for="licencias" class="block text-sm font-medium mb-2" style="color: var(--text-color);">{{ t('Licencias') }}</label>
              <InputNumber id="licencias" v-model="user.licenses" mode="decimal" />
            </FloatLabel>
          </div>
          <div class="col-span-4">
            <FloatLabel variant="in">
              <label for="begin" class="block text-sm font-medium mb-2" style="color: var(--text-color);">{{ t('Desde') }}</label>
              <InputMask v-model="user.begin" mask="99/99/9999" placeholder="99/99/9999" slot-char="dd/mm/yyyy" />
            </FloatLabel>
          </div>
          <div class="col-span-4">
            <FloatLabel variant="in">
              <label for="end" class="block text-sm font-medium mb-2" style="color: var(--text-color);">{{ t('Hasta') }}</label>
        ...
        <div class="grid grid-cols-12 gap-4">
          <div class="col-span-6">
            <FloatLabel variant="in">
              <label for="stats_min" class="block text-sm font-medium mb-2" style="color: var(--text-color);">{{ t('Inicio estadísticas')
                }}</label>
          ...
          <div class="col-span-6 flex items-center">
            ...
            <label for="manual_stats" class="font-medium ml-2" style="color: var(--text-color);">{{ t('Estadísticas manuales') }}</label>
          </div>
        </div>
        <hr />
        <div class="col-span-12 gap-4">
          <FloatLabel variant="on">
            <label for="collections" class="block text-sm font-medium mb-2" style="color: var(--text-color);">{{ t('Colecciones') }}</label>
      ...
      <Fieldset :legend="t('Restricciones')" class="col-span-12">
        <div class="grid grid-cols-12 gap-4">
          <div class="col-span-12">
            <FloatLabel variant="in">
              <label for="iprange" class="block text-sm font-medium mb-2" style="color: var(--text-color);">{{ t('Rango IP') }}</label>
          ...
          <div class="col-span-6">
            <FloatLabel variant="in">
              <label for="geoip" class="block text-sm font-medium mb-2" style="color: var(--text-color);">{{ t('GeoIP') }}</label>
          ...
          <div class="col-span-6">
            <FloatLabel variant="in">
              <label for="referer" class="block text-sm font-medium mb-2" style="color: var(--text-color);">{{ t('Referer') }}</label>
