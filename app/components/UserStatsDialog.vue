...
<template>
        ...
        <div class="grid grid-cols-12 gap-4">
          ...
          <div class="col-span-6">
            <div class="space-y-3">
              ...
              <div class="flex items-center gap-2">
                <i :class="'pi ' + (user.dashboard_access ? 'pi-check text-yellow-600' : 'pi-times text-gray-400')"></i>
        ...
        <Fieldset class="col-span-12">
          <template #legend>
            <div class="flex justify-between items-center w-full">
              <span class="text-lg font-semibold">{{ t('Estadísticas Falsas') }}</span>
              <Button 
                icon="pi pi-plus" 
                size="small"
          ...
          <div v-if="fakeStats && fakeStats.length > 0" class="overflow-auto max-h-96">
            ...
            >
              ...
              <Column field="logins" :header="t('Logins')" :sortable="true" class="text-xs">
                <template #body="slotProps">
                  <span v-if="slotProps.data.logins" class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200">
              ...
              <Column field="pages" :header="t('Páginas')" :sortable="true" class="text-xs">
                <template #body="slotProps">
                  <span v-if="slotProps.data.pages" class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200">
              ...
              <Column field="preguntas" :header="t('Preguntas')" :sortable="true" class="text-xs">
                <template #body="slotProps">
                  <span v-if="slotProps.data.preguntas" class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-purple-100 dark:bg-purple-900 text-purple-800 dark:text-purple-200">
  ...
  <Dialog 
    ...
    @update:visible="(value) => showCreateDialog = value"
    modal 
    :style="{ width: '40rem' }" 
  ...
  >
    ...
    <div class="grid grid-cols-12 gap-4">
      <div class="col-span-12">
        ...
        <Dropdown 
          v-model="newFakeStat.collection" 
          :options="user?.collections || []"
          :placeholder="t('Seleccione una colección')"
          class="w-full"
          required
          showClear
        />
      ...
      <div class="col-span-6">
        ...
        <InputText 
          v-model="newFakeStat.ts" 
          :placeholder="t('Ingrese el TS')"
          class="w-full"
        />
      </div>
    </div>
...
:deep(.dark .p-datatable-tbody > tr:hover) {
  background-color: rgb(30 58 138 / 0.2) !important; /* dark:bg-blue-900/20 */
}
